...
const socialLinks = [
  {
    href: 'https://github.com/Abdomalihi',
  ...
  {
    href: 'https://www.linkedin.com/in/abderrahmanemalihi/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Contact me to kickstart your project and create 
          ...
          <div className="flex items-center gap-2 mt-auto">
            {
              socialLinks.map(({href, icon}, key) => {
                return <a key={key} target="_blank" href={href} className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
                  {icon}
                </a>
              })
            }
        ...
        <form action="https://getform.io/f/alllerla" method="POST" className="xl:pl-10 2xl:pl-20">
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              ...
              <div className="mb-4">
                ...
                <input type="email" name="email" id="email" autoComplete="email" required placeholder="example@example.com" className="text-field reveal-up" />
              </div>
            </div>
            ...
            <div className="mb-4">
              ...
              <textarea name="message" id="message" placeholder="Hello!" required className="text-field resize-y min-h-32 max-h-80 reveal-up">
              </textarea>
            </div>
